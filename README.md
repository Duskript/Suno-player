...
> **Current build:** `0.1.11-playlist-detail-parser` (versionCode 12) — builds with JDK 17+ and Android SDK platform 35 via the Gradle wrapper. Requires JDK 17+ (Android Gradle Plugin 8.7) and the corresponding SDK platform.
