...
> **Current build:** `0.1.14-background-playback-keepalive` (versionCode 15) — builds with JDK 17+ and Android SDK platform 35 via the Gradle wrapper. Requires JDK 17+ (Android Gradle Plugin 8.7) and the corresponding SDK platform.
